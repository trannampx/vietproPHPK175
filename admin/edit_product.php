    <?php
        ...
        if(isset($_POST['sbm'])){
            ...
            $sql_prd="UPDATE product SET prd_name='$prd_name', prd_price='$prd_price',
            prd_warranty='$prd_warranty',prd_accessories='$prd_accessories',prd_promotion='$prd_promotion',
            prd_image='$prd_image',cat_id='$cat_id',prd_status='$prd_status',prd_featured='$prd_featured',
            prd_details='$prd_details' WHERE prd_id='$prd_id' ";
